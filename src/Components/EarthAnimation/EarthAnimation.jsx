    ...
    return (
        ...
        {/* </div> */}
            <div id='ZoomUpStart' className='flex justify-center absolute left-[20%] right-[20%] bottom-[90%] min-[1666px]:bottom-[85%] '>
                ...
                <div id='ZoomUpEarth' className='absolute  w-[500px] scale-0 h-[500px]  flex justify-center items-center text-center  rounded-[50%] p-[7px] min-[1666px]:w-[600px] min-[1666px]:h-[600px]'>
