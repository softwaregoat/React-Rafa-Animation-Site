    ...
    return (
            <div id='main1' className=' h-[100vh] w-[100%]'>
                <div id='MainDiv' className='w-[100%] h-[100vh] flex  justify-center relative overflow-hidden'>
                    ...
                    <div id='audio-btn' className={`absolute bottom-[5%] flex justify-center bg-black  z-50  gap-3  items-center px-5 py-3 rounded-full bg-gradient-to-r from-[#811416] to-[#E72427]`} >
