...
const VerticalMarquee = () => {
    ...
    return (
        <>
            ...
            <div className='marque-bottom w-[25%] h-[150px] absolute bottom-0 bg-gradient-to-t from-[#000] to-[#0e0e0e00] max:[390px]:w-[100%]'></div>
            <div className='marque-bottom w-[25%] h-[150px] absolute top-0 bg-gradient-to-b from-[#000] to-[#0e0e0e00]  max:[390px]:w-[100%]'></div>
