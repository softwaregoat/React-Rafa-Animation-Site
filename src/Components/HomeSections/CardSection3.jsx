        ...
        <>
            <div id='CardSection3' className='flex w-[100%] px-5 md:px-10 items-center justify-center py-16'>
                        ...
                        <div>
                            ...
                            <span className='text-[#E72427] text-6xl font-semibold w-[80%] min-[1666px]:text-7xl'>
                                <div className="ScrollImageHead3">
                                    Sim
                                    <h1 className='text-[#E72427]'>   Sim </h1>
                                    <h1 className='text-[#E72427]'>   Sim </h1>
                                    <h1 className='text-[#E72427]'>   Sim </h1>
                                    <h1 className='text-[#E72427]'>   Sim </h1>
                                </div>
                            ...
                            <span className='text-[#E72427] text-6xl font-semibold w-[80%] min-[1666px]:text-7xl'>
                                <div className="ScrollImageHead3">
                                    Setup
                                    <h1 className='text-[#E72427]'> Setup</h1>
                                    <h1 className='text-[#E72427]'> Setup</h1>
                                    <h1 className='text-[#E72427]'> Setup</h1>
                                    <h1 className='text-[#E72427]'> Setup</h1>
                                </div>
                ...
                <span className='md:hidden font-Titillium text-[20px] border-solid border-b-[1px] border-[#D9D9D9] py-5'>
                    <p>With access to our state-of-the-art racing simulators, club members can hone their skills, join league play and compete in tournaments.</p>
                </span>
            </div>
